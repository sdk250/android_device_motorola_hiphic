...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_hiphic
TARGET_RECOVERY_DEVICE_MODULES := libinit_hiphic
...
BOARD_HIPHIC_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor vendor_dlkm
BOARD_SUPER_PARTITION_SIZE := 9126805504
BOARD_SUPER_PARTITION_GROUPS := hiphic_dynamic_partitions
BOARD_HIPHIC_DYNAMIC_PARTITIONS_SIZE := 9122611200
...
BOARD_PARTITION_LIST := $(call to-upper, $(BOARD_HIPHIC_DYNAMIC_PARTITIONS_PARTITION_LIST))
...
-include vendor/motorola/hiphic/BoardConfigVendor.mk
